...
class _FixedExpenseScanScreenState extends State<FixedExpenseScanScreen> {
  ...
  Future<void> _pickAndScan() async {
    ...
    setState(() { _scanning = true; _transactions = []; _confirmed.clear(); });
    ...
    try {
      ...
      setState(() { _transactions = result; _scanned = true; });
    } catch (e) {
      if (mounted) {
        ...
        children: [
          ...
          if (_transactions.isNotEmpty) ...[
            ...
            ..._transactions.asMap().entries.map((e) =>
                _buildTransactionTile(e.key, e.value, colors)),
            ...
            if (_confirmed.isNotEmpty) ...[
              ...
              SizedBox(
                ...
                child: FilledButton(
                  ...
                  child: Text('完了（${_confirmed.length}件確認済み）',
  ...
  Widget _buildTransactionTile(int index, BankTransaction tx, CamillColors colors) {
                ...
                children: [
                  ...
                  if (hasMatch) ...[
                    ...
                    Container(
                      ...
                      child: Text('$catLabel と一致',
                          style: camillBodyStyle(11, catColor,
                              weight: FontWeight.w600)),
                    ),
                  ],
                ],
            ...
            if (hasMatch)
              isConfirmed
                  ? Icon(Icons.check_circle,
                      color: const Color(0xFF34C759), size: 28)
                  : GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text('確認',
                            style: camillBodyStyle(13, Colors.white,
                                weight: FontWeight.w600)),
                      ),
                    ),
          ],
