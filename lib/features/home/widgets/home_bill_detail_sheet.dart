...
class HomeBillDetailSheet extends StatefulWidget {
  final Bill bill;
  ...
  @override
  State<HomeBillDetailSheet> createState() => _HomeBillDetailSheetState();
}

class _HomeBillDetailSheetState extends State<HomeBillDetailSheet> {
